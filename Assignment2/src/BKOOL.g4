...
list_members: constuctor_decl | attr_decl | method_decl;
constuctor_decl: ID LB list_params? RB block_statement;
...
var_list: id_list COLON bkool_type;
id_list: ID (COMMA ID)*;
...
/*=========================== common expr ================================*/
obj_creation: NEW ID LB obj_params? RB;
obj_params: list_expr (COMMA list_expr)*;

list_expr: string_expr | boolean_expr | obj_creation | arithmetic_expr | method_access | attr_access | index_expr;
