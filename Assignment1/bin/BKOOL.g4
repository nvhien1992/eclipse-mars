...
method_decl: (primitive_type | array_type | class_type) STATIC? ID LB list_params? RB block_statement;
list_params: var_list (SEMICOLON var_list)*;

/*=========================== const declare ================================*/
const_decl: STATIC? FINAL non_void_type ID CONST_DECL const_decl_rhs SEMICOLON;
...
var_list: ID (COMMA ID)* COLON var_list_type;
var_list_type: array_type | non_void_type;
...
array_type: non_void_type LSB int_const_expr RSB;
